...
public class StoreItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Assign a StoreItemDAO for later use in initDataStoreItems()
        ...
        // Allows the Money Text to be set as the StoreItemActivity is created
    ...
    private void initDataStoreItems() {
        // Assigning dataStoreItems array list with the data from the Store Items Database
